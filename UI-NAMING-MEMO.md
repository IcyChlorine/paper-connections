...
- Runtime id: `paper-relations-topic-context-section`.
...
- Runtime id: `paper-relations-selection-debug-section`.
...
- Core ids: `paper-relations-graph-pane`, `paper-relations-graph-canvas`.
